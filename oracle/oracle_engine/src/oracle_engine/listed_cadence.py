...
def fetch_listed_count(x_whoami_get=None) -> int:
...
def listed_count_at_or_before(snapshots: list[dict], when: datetime.datetime) -> int | None:
...
def listed_count_at_or_after(snapshots: list[dict], when: datetime.datetime) -> int | None:
