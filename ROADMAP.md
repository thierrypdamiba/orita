...
| 33 | WIP (2026-07-13 09:0x UTC) | retrya | Enforce non-advice-shaped copy: a render/lint pass that rejects any published call phrased as an instruction ("buy," "sell," "you should") or claiming unlabeled certainty, mirroring the confidence-label discipline from Fencepost's `audit.py` | A test proves an instruction-phrased or confidence-unlabeled call is rejected before it can render, mirroring `fencepost/AUDIT.md`'s bar |
