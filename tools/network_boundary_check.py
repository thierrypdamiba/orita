...
swept them at task 163; thirty carry it today -- twelve more `tools/
...
now-thirty files import a network-capable module). None of them has ever
...
(eighteen at task 163, thirty today) that could itself go stale --
...
`importlib.util` (everything these thirty files actually use today)
