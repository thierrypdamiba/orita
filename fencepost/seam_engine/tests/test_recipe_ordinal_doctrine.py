...
def test_the_real_ordinal_claims_are_currently_clean():
    """Regression pin against today's real, live tree: 108 real recipes,
    the reference recipe unnumbered, the other 107 forming the unbroken
    sequence 2..108 -- no duplicate, no gap. Was 105/104/2..105 until
    ...
    assert numbered == list(range(2, 109))
