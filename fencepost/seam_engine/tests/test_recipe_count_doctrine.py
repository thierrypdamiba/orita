...
def test_real_recipe_count_is_currently_ninety():
    """Regression pin: today's real, live count under RECIPES/. Was 89 until
    RECIPES/tweet-claims-dangling-milestone/ merged (the ninetieth
    ...
    mutation test below."""
    assert real_recipe_count(FENCEPOST_ROOT) == 90
