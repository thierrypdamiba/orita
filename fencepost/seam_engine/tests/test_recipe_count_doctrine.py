...
def test_real_recipe_count_is_currently_seventy_two():
    """Regression pin: today's real, live count under RECIPES/. Was 71 until
    RECIPES/slack-message-claims-unmerged-pr/ merged (the seventy-second
    ...
    mutation test below."""
    assert real_recipe_count(FENCEPOST_ROOT) == 72
