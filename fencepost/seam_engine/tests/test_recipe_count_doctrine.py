...
def test_real_recipe_count_is_currently_fifty():
    """Regression pin: today's real, live count under RECIPES/. Was 49 until
    RECIPES/milestone-claims-unmerged-pr/ merged (the fiftieth
    ...
    mutation test below."""
    assert real_recipe_count(FENCEPOST_ROOT) == 50
