...
def test_real_recipe_count_is_currently_ninety_five():
    """Regression pin: today's real, live count under RECIPES/. Was 94 until
    RECIPES/issue-body-claims-dangling-milestone/ merged (the ninety-fifth
    ...
    mutation test below."""
    assert real_recipe_count(FENCEPOST_ROOT) == 95
