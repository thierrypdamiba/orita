...
def test_real_recipe_count_is_currently_seventy_seven():
    """Regression pin: today's real, live count under RECIPES/. Was 76 until
    RECIPES/issue-assignee-never-opened-pr/ merged (the seventy-seventh
    ...
    mutation test below."""
    assert real_recipe_count(FENCEPOST_ROOT) == 77
