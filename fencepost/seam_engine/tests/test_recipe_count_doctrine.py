...
def test_real_recipe_count_is_currently_fifty_four():
    """Regression pin: today's real, live count under RECIPES/. Was 53 until
    RECIPES/review-comment-claims-unfixed-issue/ merged (the fifty-fourth
    ...
    mutation test below."""
    assert real_recipe_count(FENCEPOST_ROOT) == 54
