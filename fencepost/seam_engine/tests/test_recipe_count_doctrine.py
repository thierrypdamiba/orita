...
def test_real_recipe_count_is_currently_sixty_seven():
    """Regression pin: today's real, live count under RECIPES/. Was 66 until
    RECIPES/slack-message-claims-unfixed-issue/ merged (the sixty-seventh
    ...
    mutation test below."""
    assert real_recipe_count(FENCEPOST_ROOT) == 67
