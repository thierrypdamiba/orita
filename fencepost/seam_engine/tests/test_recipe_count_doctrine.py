...
def test_real_recipe_count_is_currently_twenty_two():
    """Regression pin: today's real, live count under RECIPES/. Was 21 until
    RECIPES/duplicate-pr-still-open/ merged (the twenty-second real recipe)
    ...
    assert real_recipe_count(FENCEPOST_ROOT) == 22
