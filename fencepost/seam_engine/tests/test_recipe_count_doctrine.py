...
def test_real_recipe_count_is_currently_sixty_one():
    """Regression pin: today's real, live count under RECIPES/. Was 60 until
    RECIPES/unblocked-issue-still-open/ merged (the sixty-first
    ...
    test below."""
    assert real_recipe_count(FENCEPOST_ROOT) == 61
