...
def test_real_recipe_count_is_currently_sixty():
    """Regression pin: today's real, live count under RECIPES/. Was 59 until
    RECIPES/issue-comment-claims-unmerged-pr/ merged (the sixtieth
    ...
    test below."""
    assert real_recipe_count(FENCEPOST_ROOT) == 60
