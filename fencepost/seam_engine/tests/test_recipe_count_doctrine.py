...
def test_real_recipe_count_is_currently_seventy_three():
    """Regression pin: today's real, live count under RECIPES/. Was 72 until
    RECIPES/commit-claims-unmerged-pr/ merged (the seventy-third
    ...
    mutation test below."""
    assert real_recipe_count(FENCEPOST_ROOT) == 73
