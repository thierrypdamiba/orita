...
def test_real_recipe_count_is_currently_twenty_three():
    """Regression pin: today's real, live count under RECIPES/. Was 22 until
    RECIPES/release-note-dangling-reference/ merged (the twenty-third real
    ...
    test below."""
    assert real_recipe_count(FENCEPOST_ROOT) == 23
