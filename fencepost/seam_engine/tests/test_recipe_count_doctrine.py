...
def test_real_recipe_count_is_currently_ninety_one():
    """Regression pin: today's real, live count under RECIPES/. Was 90 until
    RECIPES/locked-resolved-pr-still-open/ merged (the ninety-first
    ...
    mutation test below."""
    assert real_recipe_count(FENCEPOST_ROOT) == 91
