...
def test_real_recipe_count_is_currently_eighty():
    """Regression pin: today's real, live count under RECIPES/. Was 79 until
    RECIPES/repo-description-dangling-reference/ merged (the eightieth
    ...
    mutation test below."""
    assert real_recipe_count(FENCEPOST_ROOT) == 80
