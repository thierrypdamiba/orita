...
def test_real_recipe_count_is_currently_sixty_four():
    """Regression pin: today's real, live count under RECIPES/. Was 63 until
    RECIPES/locked-resolved-issue-still-open/ merged (the sixty-fourth real
    ...
    test below."""
    assert real_recipe_count(FENCEPOST_ROOT) == 64
