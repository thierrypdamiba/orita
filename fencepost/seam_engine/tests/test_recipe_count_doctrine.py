...
def test_real_recipe_count_is_currently_sixty_five():
    """Regression pin: today's real, live count under RECIPES/. Was 64 until
    RECIPES/draft-pr-closes-keyword-issue/ merged (the sixty-fifth real
    ...
    test below."""
    assert real_recipe_count(FENCEPOST_ROOT) == 65
