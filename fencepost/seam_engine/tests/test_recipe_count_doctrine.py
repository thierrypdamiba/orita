...
def test_real_recipe_count_is_currently_ninety_four():
    """Regression pin: today's real, live count under RECIPES/. Was 93 until
    RECIPES/approved-pr-still-unmerged/ merged (the ninety-fourth
    ...
    mutation test below."""
    assert real_recipe_count(FENCEPOST_ROOT) == 94
