...
def test_real_recipe_count_is_currently_sixty_six():
    """Regression pin: today's real, live count under RECIPES/. Was 65 until
    RECIPES/commit-claims-open-milestone/ merged (the sixty-sixth real
    ...
    test below."""
    assert real_recipe_count(FENCEPOST_ROOT) == 66
