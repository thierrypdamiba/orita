...
def test_real_recipe_count_is_currently_eighty_nine():
    """Regression pin: today's real, live count under RECIPES/. Was 88 until
    RECIPES/release-claims-dangling-milestone/ merged (the eighty-ninth
    ...
    mutation test below."""
    assert real_recipe_count(FENCEPOST_ROOT) == 89
