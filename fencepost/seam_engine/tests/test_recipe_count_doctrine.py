...
def test_real_recipe_count_is_currently_forty_seven():
    """Regression pin: today's real, live count under RECIPES/. Was 46 until
    RECIPES/mention-claims-unfixed-issue/ merged (the forty-seventh
    ...
    mutation test below."""
    assert real_recipe_count(FENCEPOST_ROOT) == 47
