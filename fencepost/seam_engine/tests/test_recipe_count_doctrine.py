...
def test_real_recipe_count_is_currently_forty():
    """Regression pin: today's real, live count under RECIPES/. Was 39 until
    RECIPES/merged-pr-branch-not-deleted/ merged (the fortieth real recipe)
    ...
    assert real_recipe_count(FENCEPOST_ROOT) == 40
