...
def test_real_recipe_count_is_currently_twenty_five():
    """Regression pin: today's real, live count under RECIPES/. Was 24 until
    RECIPES/commit-closes-keyword-pr-still-open/ merged (the twenty-fifth
    ...
    mutation test below."""
    assert real_recipe_count(FENCEPOST_ROOT) == 25
