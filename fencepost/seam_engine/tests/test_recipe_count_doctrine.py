...
def test_real_recipe_count_is_currently_twelve():
    """Regression pin: today's real, live count under RECIPES/. Was 11 until
    RECIPES/merged-pr-never-released/ merged (the twelfth real recipe) --
    ...
    assert real_recipe_count(FENCEPOST_ROOT) == 12
