...
def test_real_recipe_count_is_currently_thirteen():
    """Regression pin: today's real, live count under RECIPES/. Was 12 until
    RECIPES/release-claims-unfixed-issue/ merged (the thirteenth real
    ...
    test below."""
    assert real_recipe_count(FENCEPOST_ROOT) == 13
