...
def test_runs_all_real_recipes_in_the_actual_repo_without_error(monkeypatch):
    ...
    # real recipes shipped by tasks 22, 108, 110, 368, 371, 373, 376, 377, 378, 379, 380, 381, 382, 383, 384, 385, 386, 388, 390, 398, 399, 400, 401, 402, 403, 419, 450, 451, 452, 485, 486, 488, 489, 490, 491, 492, 493, 499, 512, 514, 520, 527, 530, 534, 535, 558, 564, 579, 581, 582, 585, 588, 589, 590, 591, 592, 593, 594, 595, 596, 645, 646, 648, 652, 653, 665, 702, 865, 866, 867, 868, 869, 870, 871, 872, 873, 874, 876, 966, 1000, 1046, plus mention-claims-open-milestone, mention-claims-unmerged-pr, milestone-claims-unmerged-pr, milestone-claims-open-milestone, merged-pr-requested-reviewer-never-reviewed, locked-resolved-issue-still-open, draft-pr-closes-keyword-issue, commit-claims-open-milestone, slack-message-claims-unfixed-issue, linear-comment-claims-unfixed-issue, slack-message-claims-open-milestone, linear-comment-claims-open-milestone, linear-comment-claims-unmerged-pr, slack-message-claims-unmerged-pr, commit-claims-unmerged-pr, linear-comment-dangling-reference, slack-message-dangling-reference, milestone-deadline-no-calendar-event, repo-description-dangling-reference, issue-comment-claims-dangling-milestone, review-comment-claims-dangling-milestone, slack-message-claims-dangling-milestone, linear-comment-claims-dangling-milestone, unblocked-pr-still-open, mention-claims-dangling-milestone, milestone-claims-dangling-milestone, readme-claims-dangling-milestone, release-claims-dangling-milestone, tweet-claims-dangling-milestone, locked-resolved-pr-still-open, issue-body-claims-open-milestone, email-claims-unfixed-issue, email-dangling-reference, email-claims-unmerged-pr, email-claims-open-milestone, email-claims-dangling-milestone), the combined scan runs clean.
    monkeypatch.setattr(scan_mod, "fetch_github_activity", lambda *a, **k: [])
