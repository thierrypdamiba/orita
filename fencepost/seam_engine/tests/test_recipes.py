...
def test_real_plus_joined_counts_are_currently_twenty_eight_of_ninety():
    # Regression pin: today's real, live counts under RECIPES/. Was (27, 89)
    # until tweet-claims-dangling-milestone merged (the ninetieth
    # real recipe, toolkit "x+github" -- IS plus-joined, so both halves
    # climb this time: 28 of 90.
    ...
    # pinning this number.
    assert real_plus_joined_counts(FENCEPOST_ROOT) == (28, 90)
