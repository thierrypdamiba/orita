...
def test_real_plus_joined_counts_are_currently_thirty_eight_of_one_hundred_six():
    ...
    # both counts climb together this time: 38 of 106.
    ...
    # pinning this number.
    assert real_plus_joined_counts(FENCEPOST_ROOT) == (38, 106)
