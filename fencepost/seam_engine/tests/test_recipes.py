...
def test_real_plus_joined_counts_are_currently_eleven_of_thirty_three():
    # Regression pin: today's real, live counts under RECIPES/. Was (11, 32)
    # until overdue-milestone-still-open merged (the thirty-third real
    # recipe, task 489, single-toolkit -- the plus-joined half stays 11).
    assert real_plus_joined_counts(FENCEPOST_ROOT) == (11, 33)
