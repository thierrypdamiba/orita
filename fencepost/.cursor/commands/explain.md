---
description: Plain-English view of any safeword block, verdict, ticket, or your current state (project)
---

# Explain

Translate safeword's dense artifacts and current state into plain English — what
this is, why it matters, what to do next.

**Read-only.** This command only reads and explains; it never edits, writes, or
changes any file. Do not modify anything while running it.
...
Code diffs and PRs are out of scope — base agents already explain those well.
